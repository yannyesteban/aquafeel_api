...
module.exports.edit = async (req, res, next) => {
	try {
		let { business_name, first_name, last_name, phone, phone2, email, street_address, apt, city, state, zip, country, longitude, latitude, appointment_date, appointment_time, status_id, owned_by, id, note, user_id, favorite } = req.body;
